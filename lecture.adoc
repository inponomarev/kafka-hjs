...
digraph G {
    ...
    rankdir="LR"
      ...
      subgraph cluster_s2{
        Consumer[shape="circle",style="rounded",label="C1"];
...
digraph G {
    ...
    rankdir="LR"
    subgraph cluster_s2{
        Consumer[shape="circle",style="rounded",label="C1", style="filled"];
        Consumer2[shape="circle",style="rounded",label="C2",style="invis"]
        style="rounded";
        label="Group"
   }
...
digraph G {
   graph [ dpi = 200 ];
    ...
    subgraph cluster_s2{
        Consumer[shape="circle",style="rounded",label="C1", style="filled"];
        Consumer2[shape="circle",style="rounded",label="C2"]
        style="rounded";
        label="Group"
   }
...
digraph G {
    ...
    subgraph cluster_s2{
        Consumer[shape="circle",style="rounded",label="C1", style="invis"];
        Consumer2[shape="circle",style="rounded",label="C2"]
        style="rounded";
        label="Group"
   }
...
digraph G {
  ...
  s3[label="segment 3",style="filled",fillcolor="green"]
  s3->"segment 2"->"segment 1"
  
  
  nm[label="new messages",shape="oval"]
  nm->s3
  {rank =same; nm; s3}
