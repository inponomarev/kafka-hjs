...
image::oak-log.jpg[{image-30-width}]
...
image::oak-log.jpg[{image-60-width}]
...
digraph G {
  ...
  Ledger [shape="none",label="",
      image="src/main/asciidoc/images/oak-log-cropped.jpg"];
...
digraph D {
  ...
  zk1[shape="none",label="",
      image="src/main/asciidoc/images/zookeeper-logo-small.png"];

  zk2[shape="none",label="",
      image="src/main/asciidoc/images/zookeeper-logo-small.png"];

  zk3[shape="none",label="",
      image="src/main/asciidoc/images/zookeeper-logo-small.png"];
   ...
   rankdir = LR;
    subgraph cluster_t1 {
      ...
      T1[shape="none"; style="invis"; label=<<table cellspacing="5" cellborder="0"  border="1">
        <tr><td style="invis"><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td><td style="invis"><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td></tr>
        <hr/>
        <tr><td style="invis"><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td><td style="invis"><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td></tr>
        <hr/>
        <tr><td style="invis"><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td><td style="invis"><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td></tr>
  ...
  graph [ dpi = 180 ]; 
   ...
   rankdir = LR;
    subgraph cluster_t1 {
      ...
      style = "rounded";
      T1[shape="none"; label=<<table cellspacing="5" cellborder="0"  border="1">
        <tr><td><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td><td><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td></tr>
        <hr/>
        <tr><td><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td><td><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td></tr>
        <hr/>
        <tr><td><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td><td><IMG SCALE="BOTH" SRC="src/main/asciidoc/images/message-small.png"/></td></tr>
  ...
  subgraph system {
    ...
    subgraph cluster_p1 {
      label = "Worker 1";
        ...
        ls1[shape="cylinder" label = "A: 15, B: 10, D: 20"]
        a->ls1;
        b->ls1;
        c->ls1;
  ...
  subgraph system {
    ...
    subgraph cluster_p1 {
      label = "Worker 1";
        ...
        ls1[shape="cylinder" label = "A: 19, B: 12, D: 22"]
        a->ls1;
        b->ls1;
        c->ls1;
  ...
  subgraph system {
    ...
    subgraph cluster_p1 {
      label = "Worker 1";
        ...
        ls1[shape="cylinder" label = "A: 19, B: 12"]
        a->ls1;
        b->ls1;
        c->ls1;
  ...
  subgraph system {
    ...
    subgraph cluster_p1 {
      label = "Worker 1";
        ...
        ls1[shape="cylinder" label = "A: 21, B: 13"]
        a->ls1;
        b->ls1;
        c->ls1;
  ...
  subgraph system {
    ...
    subgraph cluster_p1 {
      label = "Worker 1";
        ...
        ls1[shape="cylinder" label = "A: 21, B: 13, D: 23"]
        a->ls1;
        b->ls1;
        c->ls1;
