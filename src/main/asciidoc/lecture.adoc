   ...
   rankdir = LR;
    subgraph cluster_t1 {
      ...
      T1[shape="none"; label=<<table cellspacing="5" cellborder="0"  border="1">
                    <tr><td port="p0">partition 0</td></tr>
                    <hr/>
                    <tr><td>partition 1</td></tr>
                    <hr/>
                    <tr><td>partition 2</td></tr>
                    <hr/>
                    <tr><td>partition 3</td></tr>
                    <hr/>
                    <tr><td>partition 4</td></tr>
            </table>>; style="invis"]
    }
  ...
  graph [ dpi = 180 ]; 
   ...
   rankdir = LR;
    subgraph cluster_t1 {
      ...
      style = "rounded";
      T1[shape="none"; label=<<table cellspacing="5" cellborder="0"  border="1">
                    <tr><td port="p0"><IMG SCALE="TRUE" SRC="src/main/asciidoc/images/message.png"/>
                    <IMG SCALE="TRUE" SRC="src/main/asciidoc/images/message.png"/></td></tr>
                    <hr/>
                    <tr><td><IMG SCALE="TRUE" SRC="src/main/asciidoc/images/message.png"/>
                    <IMG SCALE="TRUE" SRC="src/main/asciidoc/images/message.png"/>
                    <IMG SCALE="TRUE" SRC="src/main/asciidoc/images/message.png"/>
                    </td></tr>
                    <hr/>
                    <tr><td><IMG SCALE="TRUE" SRC="src/main/asciidoc/images/message.png"/>
